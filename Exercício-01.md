...
- [X] o TCP/IP, o primeiro navegador Mosaic e o nome WWW
- [ ] a linguagem HTML, o protocolo HTTP e o nome WWW
...
### 7. Uma URL é composta por vários componentes. Na URL https://github.com/LeoSouzaSenac/UC14/new/main, são respectivamente o domínio, o protocolo e o caminho os itens apontados na opção:

- [ ] github.com / https / LeoSouzaSenac
- [ ] github.com / www / LeoSouzaSenac
- [ ] github / https / LeoSouzaSenac
- [X] www.github.com / https / LeoSouzaSenac
...
### Considere a seguinte URL: https://github.com/LeoSouzaSenac/UC14/new/main

Identifique as diferentes partes desta URL:

Protocolo: [X] https
Subdomínio: [ ] (não há subdomínio)
Domínio: [X] github.com
Caminho do Diretório: [X] LeoSouzaSenac/UC14/new/main
